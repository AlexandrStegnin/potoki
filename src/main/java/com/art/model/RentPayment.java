...
public class RentPayment {
  ...
  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "rent_payment_generator")
  @SequenceGenerator(name = "rent_payment_generator", sequenceName = "rent_payment_id_seq")
  @Column(name = "id")
  private Long id;
