...
public class CompanyInvestorProfitUnionController {
    ...
    public List<CompanyInvestorProfitUnion> findByLogin() {
        List<CompanyInvestorProfitUnion> profitUnions = new ArrayList<>();
        List<CompanyProfit> companyProfits = companyProfitService.findAll();
        List<InvestorProfit> investorProfits = investorProfitService.findByLogin("investor007");
        ...
        profitUnions.forEach(profitUnion -> {
            investorProfits.stream()
