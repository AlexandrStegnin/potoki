...
<div class="generic-container">
    ...
    <form:form method="POST" modelAttribute="allowanceIp" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="investors">Инвестор:</label>
                <div class="col-md-7">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="date" path="dateStart" id="dateStart" class="form-control input-sm" />
                    <div class="has-error">
                        <form:errors path="dateStart" class="help-inline"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="summ">Надбавка ИП:</label>
                <div class="col-md-7">
                    <form:input type="number" path="allowance" id="summ" class="form-control input-sm"
                                min="0.0" step="0.01"/>
                    <div class="has-error">
                        <form:errors path="allowance" class="help-inline"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <c:choose>
                    <c:when test="${edit}">
                        <input type="submit" value="Обновить" class="btn btn-primary btn-sm"/> или <a href="<c:url value='/allowanceip' />">Отмена</a>
                    </c:when>
                    <c:otherwise>
                        <input type="submit" value="Создать" class="btn btn-primary btn-sm"/> или <a href="<c:url value='/allowanceip' />">Отмена</a>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
