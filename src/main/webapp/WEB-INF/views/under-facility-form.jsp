...
<div class="modal" tabindex="-1" role="dialog" id="uf-modal-form">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form:form method="POST" modelAttribute="underFacilityDTO" class="form-horizontal"
                               style="margin: 10px 0 10px 0" id="facility-form">
                        <form:input type="hidden" path="id" id="uf-id"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="has-error d-none" id="ufNameError">
