            ...
            <c:forEach items="${shareKindList}" var="kinds">
                <tr id="${kinds.id}">
                    ...
                    <sec:authorize access="isFullyAuthenticated()">
                        <sec:authorize access="hasRole('ADMIN') or hasRole('DBA')">
                            <td style="text-align: center"><a href="<c:url value='/edit-shareKind-${kinds.id}' />"
                                                              id="editShare" name="${kinds.id}"
                                                              data-toggle="${kinds.shareKind}"
                                                              class="btn btn-success custom-width">Изменить</a></td>
                        </sec:authorize>
                        <sec:authorize access="hasRole('ADMIN')">
                            <td style="text-align: center"><a href="<c:url value='/deleteShareKind'/>" id="delete"
                                                              name="${kinds.id}"
                ...
                <form:form method="POST" modelAttribute="shareKind" class="form-horizontal" id="shareKind">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <form:input type="text" path="shareKind" id="shareKindName"
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="form-actions floatRight">
                        ...
                        <a href="<c:url value='/viewShareKind' />" class="btn btn-link btn-sm"
                           id="cancelShare">Отмена</a>
                    </div>
                </div>
            </div>
        </div>
