...
<div class="generic-container">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading"><span class="lead">Инвесторы. Суммы:</span></div>
        ...
        <table class="table table-hover" id="investorsSummary">
            ...
            <tbody>
            <c:forEach items="${investorsCashSums}" var="sums">
                <tr>
                    <td>${sums.getDateGivedCashToLocalDate()}</td>
                    <td>${sums.facility}</td>
