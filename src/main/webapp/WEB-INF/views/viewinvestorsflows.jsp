    ...
    <div class="panel panel-default">
        ...
        <form:form modelAttribute="searchSummary" method="POST" class="form-inline" id="filter-form">
            <div class="row" style="margin: 10px;">
                ...
                <form:select path="facility" id="fFacilities" items="${facilitiesList}" multiple="false"
                ...
                <form:form method="POST" modelAttribute="fileBucket" enctype="multipart/form-data" class="form-inline"
                    ...
                    <div class="row" style="margin: 10px;">
                        <label class="sr-only" for="file">Загрузить файл</label>
                            <form:input cssStyle="width: 40%" type="file" path="file" id="file" class="form-control input-sm col-sm-8"/>
                            <div class="has-error">
                                <form:errors path="file" class="help-inline"/>
                            </div>
                        <input type="submit" value="Загрузить" class="btn btn-primary btn-sm" style="margin-left: 10px" id="loadInvFlowsAjax">
                        <a href="<c:url value='/deleteFlows' />" class="btn btn-danger btn-sm" style="margin-left: 10px">Удалить</a>
        ...
        <table class="table table-hover" style="font-size: small" id="invFlows">
            ...
            <c:forEach items="${investorsFlows}" var="flows">
                <tr id="${flows.id}">
                    ...
                    <td>
                        <fmt:formatNumber value="${flows.afterDeductionEmptyFacility}" type="currency" minFractionDigits="2"/>
                    </td>
                ...
                <form:form method="POST" modelAttribute="searchSummary" class="form-horizontal" id="reInvestData">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                ...
                                <div id="dateRepErr" style="color: red; display: none">Необходимо выбрать дату вложения</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="facilitiesRow">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <form:select path="reFacility" id="srcFacilities" items="${facilitiesList}" multiple="false"
                                             itemValue="id" itemLabel="facility" class="form-control input-sm"/>
                    ...
                    <div class="row" id="invTypeRow">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                ...
                                <div id="invTypeErr" style="color: red; display: none">Необходимо выбрать вид инвестора</div>
                            </div>
                        </div>
                    </div>
