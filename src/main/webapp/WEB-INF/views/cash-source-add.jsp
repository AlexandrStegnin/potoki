...
<div class="generic-container">
    ...
    <form:form method="POST" modelAttribute="cashSource" class="form-horizontal" id="cashSrc">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="text" path="name" id="source" class="form-control input-sm"/>
                    <div class="has-error">
        ...
        <div class="row">
            <div class="form-actions floatRight">
                ...
                <input type="submit" value="${title}" class="btn btn-primary btn-sm"/> или <a href="<c:url value='/cash-sources/list' />">Отмена</a>
            </div>
        </div>
    </form:form>
</div>
