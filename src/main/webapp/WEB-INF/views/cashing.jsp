    ...
    <form:form method="POST" modelAttribute="searchSummary" class="form-horizontal">
        ...
        <div class="row" id="facilitiesRow">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:select path="money.facility" id="facility" items="${facilities}" multiple="false"
        ...
        <div class="row" id="underFacilitiesRow">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:select path="money.underFacility" id="underFacility" multiple="false"
        ...
        <div class="row" id="investorRow">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:select path="money.investor" id="investor" items="${investorsMulti}"
        ...
        <div class="row" id="cashRow">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="number" path="money.givenCash" id="cash" class="form-control input-sm"
                                min="0.0" step="any"/>
        ...
        <div class="row" id="dateGivedCashRow">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="date" path="money.dateGiven" id="dateGivedCash"
                                class="form-control input-sm"/>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-actions floatRight">
                ...
                <a href="<c:url value='/money/list' />">Отмена</a>
            </div>
        </div>
    </form:form>
</div>
