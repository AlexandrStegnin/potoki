...
<div class="modal" tabindex="-1" role="dialog" id="cash-detail-modal-form">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <form:form method="POST" modelAttribute="newCashDetailDTO" class="form-horizontal"
                               style="margin: 10px 0 10px 0" id="new-cash-detail-form">
                        <form:input type="hidden" path="id" id="new-cash-detail-id"/>
