...
<div class="generic-container">
    ...
    <div class="well">
        <sec:authorize access="hasRole('ADMIN') or hasRole('DBA') or hasRole('BIGDADDY')">
            ...
            <a href="<c:url value='/alphaextract' />" class="btn btn-success btn-block">Посмотреть выгрузки Альфа
                банка</a>
        ...
        <sec:authorize access="hasRole('ADMIN') or hasRole('DBA') or hasRole('BIGDADDY') or hasRole('INVESTOR')">
            <a href="<c:url value='/investorstotalsum' />" class="btn btn-success btn-block">Инвесторы. Вложено
                денег</a>
        ...
        <sec:authorize access="hasRole('OLD')">
            ...
            <a href="<c:url value='/investorstotalsum' />" class="btn btn-success btn-block">Инвесторы. Вложено
                денег</a>
            <a href="<c:url value='/investorsplansale' />" class="btn btn-success btn-block">Инвесторы. Плановая
                доходность</a>
        </sec:authorize>
    </div>
