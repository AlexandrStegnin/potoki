                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="/facility/create">
                              <span style="margin-right: 5px;  color: dodgerblue;"
                                    class="glyphicon glyphicon-plus"></span>Добавить объект</a></li><li><a href="/update-inv-demo" id="updateInvestorDemo"><span style="margin-right: 5px;  color: dodgerblue;" class="glyphicon glyphicon-refresh"></span>Обновить инвестор-демо</a></li>
