            ...
            <c:forEach items="${investorsTypes}" var="invType">
                <tr id="${invType.id}">
                    ...
                    <sec:authorize access="isFullyAuthenticated()">
                        <sec:authorize access="hasRole('ADMIN') or hasRole('DBA')">
                            <td style="text-align: center"><a href="<c:url value='/edit-invtype-${invType.id}' />" class="btn btn-success custom-width">Изменить</a></td>
                        </sec:authorize>
                        <sec:authorize access="hasRole('ADMIN')">
                            <td style="text-align: center"><a href="<c:url value='/deleteinvtype'/>" id="delete" name="${invType.id}"
