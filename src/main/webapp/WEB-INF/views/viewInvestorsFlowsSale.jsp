            ...
            <sec:authorize access="hasRole('ADMIN')">
                <form:form method="POST" modelAttribute="fileBucket" enctype="multipart/form-data" class="form-inline"
                    ...
                    <div class="row" style="margin: 10px;">
                        ...
                        <input type="submit" value="Загрузить" class="btn btn-primary btn-sm" style="margin-left: 10px" id="loadInvFlowsSaleAjax">
                        <a href="<c:url value='/deleteFlowsSale' />" class="btn btn-danger btn-sm" style="margin-left: 10px">Удалить</a>
