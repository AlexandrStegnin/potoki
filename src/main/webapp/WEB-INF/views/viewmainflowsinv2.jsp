    ...
    <div class="row">
        <div class="col-md-6" style="margin-bottom: 10px; height: 50%; overflow-y: scroll; padding-left: 10%; padding-right: 10%">
            <div class="panel panel-default">
                ...
                <div class="panel-heading"><span class="lead" style="font-weight: bold" id="monthAndYear">${monthAndYear}</span></div>
                ...
                <table class="table bordered" id="invPaysMonth">
                    ...
                    <tr>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <fmt:formatNumber var="percent" value="${(summaPaysMonth / finalMaxSumMonth)*100}" maxFractionDigits="0"/>
                                <fmt:formatNumber var="middle" value="${(percent + 100)/2}" maxFractionDigits="0"/>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <td><a id="goPays" name="monthPays" href="<c:url value='/#' />" class="btn btn-link custom-width">Подробно</a></td>
                    </tr>
                    <tr>
                        <td>Аренда</td>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <fmt:formatNumber var="percent" value="${(summaArendiMonth / finalMaxSumMonth)*100}" maxFractionDigits="0"/>
                                <fmt:formatNumber var="middle" value="${(percent + 100)/2}" maxFractionDigits="0"/>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <td><a id="goArendaMonth" name="monthArenda" href="<c:url value='/#' />" class="btn btn-link custom-width">Подробно</a></td>
                    </tr>
                    <tr>
                        <td>Расходы</td>
                        ...
                        <td><a id="goRashodiMonth" name="monthRashodi" href="<c:url value='/#' />" class="btn btn-link custom-width">Подробно</a></td>
                    </tr>
                    </tbody>
                </table>
                    ...
                    <c:forEach items="${invCash}" var="cash">
                        <tr>
                            ...
                            <td><a id="goCash" name="${cash.facility.facility}"
                                   href="<c:url value='/sumdetails' />" class="btn btn-link custom-width">Подробно</a></td>
                        </tr>
                    </c:forEach>
                    <tr>
        ...
        <div class="col-md-6" style="margin-bottom: 10px; height: 50%; overflow-y: scroll; padding-left: 10%; padding-right: 10%">
            <div class="panel panel-default">
                ...
                <table class="table table-hover" id="invPaysAll">
                    ...
                    <tr>
                        <td>Вы заработали</td>
                        <fmt:formatNumber var="percent" value="${(summaPays / finalMaxSumAll)*100}" maxFractionDigits="0"/>
                        <fmt:formatNumber var="middle" value="${(percent + 100)/2}" maxFractionDigits="0"/>
                        <td style="background: linear-gradient(to right, white 50%, rgb(100, 195, 132) 50%, rgb(229, 245, 234) ${middle}%,
                        ...
                        <td><a id="goPaysAll" name="allPays" href="<c:url value='/#' />" class="btn btn-link custom-width">Подробно</a></td>
                    </tr>
                    <tr>
                        <td>Аренда</td>
                        <fmt:formatNumber var="percent" value="${(summaArendiAll / finalMaxSumAll)*100}" maxFractionDigits="0"/>
                        <fmt:formatNumber var="middle" value="${(percent + 100)/2}" maxFractionDigits="0"/>
                        <td style="background: linear-gradient(to right, white 50%, rgb(100, 195, 132) 50%, rgb(229, 245, 234) ${middle}%,
                                white ${percent}%); text-align: right; padding: 0">
                            <fmt:setLocale value = "ru-RU" scope="session"/>
                        ...
                        <td><a id="goArendaAll" name="allArenda" href="<c:url value='/#' />" class="btn btn-link custom-width">Подробно</a></td>
                    </tr>
                    <tr>
                        <td>Расходы</td>
                        <fmt:formatNumber var="percent" value="${(summaArendiAll / finalMaxSumAll)*100}" maxFractionDigits="0"/>
                        ...
                        <td><a id="goRashodiAll" name="allRashodi" href="<c:url value='/#' />" class="btn btn-link custom-width">Подробно</a></td>
                    </tr>
                    </tbody>
                </table>
